...
<a href="#contacto" class="scroll"><h4>CONTÁCTENOS</h4></a>
</header>
<section>
    <div class="botones">
...
<section class="section3" id="contacto">
    <form action="index.php?c=Usuarios&a=enviarContacto" target="_blank" method="post" class="formulario">
            ...
            <input type="text" id="email" name="Email" placeholder="Escribe tu e-mail*"><br><br>
            ...
            <input type="text" id="mensaje" name="Mensaje" placeholder="Escribe tu mensaje*"><br><br><br><br>
