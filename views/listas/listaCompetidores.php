  ...
  <form method="GET" action="resultado_buscador.php" class="resutlado_buscador">
    ...
    <table border="1" width="80%" class="table">
      ...
      <?php foreach($data["Competidor"] as $dato) {
          ...
          echo "<td><a href='index.php?c=listas&a=agregar&id=" . $dato["idCompetidores"] . "'class='boton-tabla'>Agregar</a></td>";
          echo "<td><a href='index.php?c=listas&a=modificar&id=" . $dato["idCompetidores"] . "'class='boton-tabla'>Modificar</a></td>";
          echo "<td><a href='index.php?c=listas&a=eliminar&id=" . $dato["idCompetidores"] . "' class='boton-tabla'>Eliminar</a></td>";
          echo "</tr>";
        }
      ?>
      </tbody>
